...
export const RERANK_FINAL_RESULTS = parseInt(process.env.RERANK_FINAL_RESULTS!, 10) || 5;

/** Truncation limit for document content (saves tokens, reduces latency) */
export const RERANK_CONTENT_MAX_LENGTH = parseInt(process.env.RERANK_CONTENT_MAX_LENGTH!, 10) || 800;

/** Strict timeout for the single LLM reranking call (in milliseconds) */
export const RERANK_TIMEOUT_MS = parseInt(process.env.RERANK_TIMEOUT_MS!, 10) || 4000;
